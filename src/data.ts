...
export const PROJECTS: Project[] = [
  ...
  { id: '02', type: 'WEB APPLICATION', title: 'Auction Football System', image: 'auction.png', desc: 'A high-performance auction platform for football clubs to bid on player transfers with real-time updates and secure payments.', metrics: [], stack: ['React', 'Node.js', 'Supabase', 'Stripe'], links: { source: 'https://github.com/syedfiras/auction', preview: 'https://auction-football.netlify.app/login' }, featured: false, status: 'live' },
