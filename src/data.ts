...
export const PROJECTS: Project[] = [
  ...
  { id: '04', type: 'WEB APPLICATION', title: 'IJESTM Journal Platform', image: 'ijestm.png', desc: 'A college journal website for AITM with advanced SEO features tailored for academic publications and research papers.', metrics: [], stack: [ 'Next.js', 'TypeScript'], links: { source: '', preview: 'https://ijestm.aitm.edu.in/' }, featured: true, status: 'live' },
  { id: '05', type: 'AI PLATFORM', title: 'FootballCoach AI', image: 'footballcoachai.png', desc: 'AI-powered football coaching assistant — tactical analysis, drill generation, and performance insights. Live with real-time AI insights.', metrics: [], stack: ['React.js', 'Node.js','Supabase', 'OpenRouter'], links: { source: '', preview: 'https://footballcoachai.netlify.app/' }, featured: true, status: 'live' },
